...
![چگونه می‌توان پنهان‌سازی/سایه‌گذاری متد را در سی‌شارپ پیاده‌سازی کرد؟](https://dotnettutorials.net/wp-content/uploads/2022/07/word-image-27425-1-9.png "چگونه می‌توان پنهان‌سازی/سایه‌گذاری متد را در سی‌شارپ پیاده‌سازی کرد؟")
...
![مثالی برای درک پنهان‌سازی/سایه‌گذاری متد در سی‌شارپ](https://dotnettutorials.net/wp-content/uploads/2022/07/word-image-27425-2-13.png "مثالی برای درک پنهان‌سازی/سایه‌گذاری متد در سی‌شارپ")
...
![پنهان‌سازی/سایه‌گذاری متدها در سی‌شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/07/word-image-27425-3-11.png "پنهان‌سازی/سایه‌گذاری متدها در سی‌شارپ به همراه مثال")
...
![لغو متد و پنهان‌سازی متد در سی‌شارپ](https://dotnettutorials.net/wp-content/uploads/2022/07/word-image-27425-4-12.png "لغو متد و پنهان‌سازی متد در سی‌شارپ")
...
![چرا از کلمه کلیدی new در Method Hiding استفاده می‌کنیم؟](https://dotnettutorials.net/wp-content/uploads/2022/07/word-image-27425-5-10.png "چرا از کلمه کلیدی new در Method Hiding استفاده می‌کنیم؟")
...
![چگونه می‌توان متدهای کلاس والد را از متدهای پیاده‌سازی‌شده‌ی کلاس فرزند فراخوانی کرد؟](https://dotnettutorials.net/wp-content/uploads/2022/07/word-image-27425-6-12.png "چگونه می‌توان متدهای کلاس والد را از متدهای پیاده‌سازی‌شده‌ی کلاس فرزند فراخوانی کرد؟")
...
![نحوه فراخوانی متدهای کلاس والد از متدهای پیاده‌سازی‌شده کلاس فرزند در سی‌شارپ](https://dotnettutorials.net/wp-content/uploads/2022/07/word-image-27425-7-11.png "نحوه فراخوانی متدهای کلاس والد از متدهای پیاده‌سازی‌شده کلاس فرزند در سی‌شارپ")
...
![تفاوت‌های بین لغو متد (Method Override) و پنهان‌سازی متد (Method Hiding) در سی‌شارپ](https://dotnettutorials.net/wp-content/uploads/2022/07/word-image-27425-8-11.png "تفاوت‌های بین لغو متد (Method Override) و پنهان‌سازی متد (Method Hiding) در سی‌شارپ")
...
![پنهان‌سازی متد در سی‌شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/07/word-image-27425-9-8.png "پنهان‌سازی متد در سی‌شارپ به همراه مثال")
