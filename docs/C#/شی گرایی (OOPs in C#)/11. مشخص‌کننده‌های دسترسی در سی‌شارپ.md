...
![درک نوع و اعضای نوع در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/08/type-and-type-members-in-c.jpeg "درک نوع و اعضای نوع در سی شارپ")
...
![مثالی برای درک مشخص‌کننده‌های دسترسی در سی‌شارپ](https://dotnettutorials.net/wp-content/uploads/2022/08/access-specifiers-in-c.jpeg "مثالی برای درک مشخص‌کننده‌های دسترسی در سی‌شارپ")پس از کلیک بر روی پروژه جدید، کادر محاوره‌ای افزودن پروژه جدید زیر باز می‌شود. در اینجا، ابتدا در پنجره جستجو، کتابخانه کلاس را جستجو کنید و سپس **با استفاده از الگوی پروژه زبان C# ، کتابخانه کلاس (.NET Framework)** را انتخاب کنید و سپس مطابق تصویر زیر، بر روی دکمه بعدی کلیک کنید.

![مشخص‌کننده‌های دسترسی در سی‌شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-3-1.png "مشخص‌کننده‌های دسترسی در سی‌شارپ به همراه مثال")
...
![مشخص‌کننده‌های دسترسی در سی‌شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-4.png "مشخص‌کننده‌های دسترسی در سی‌شارپ به همراه مثال")
...
![مشخص کننده‌های دسترسی در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-5.png "مشخص کننده‌های دسترسی در سی شارپ")
...
![مشخص کننده یا اصلاح کننده دسترسی خصوصی در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-6.png "مشخص کننده یا اصلاح کننده دسترسی خصوصی در سی شارپ")
...
![مشخص کننده یا اصلاح کننده دسترسی خصوصی در سی شارپ با مثال](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-7.png "مشخص کننده یا اصلاح کننده دسترسی خصوصی در سی شارپ با مثال")
...
![افزودن مرجع اسمبلی در چارچوب .NET](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-8.png "افزودن مرجع اسمبلی در چارچوب .NET")
...
![افزودن مرجع اسمبلی در چارچوب .NET](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-9.png "افزودن مرجع اسمبلی در چارچوب .NET")
...
![مشخص کننده یا اصلاح کننده دسترسی در سی شارپ با مثال](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-10.png "مشخص کننده یا اصلاح کننده دسترسی در سی شارپ با مثال")
...
![مشخص کننده دسترسی محافظت شده یا اصلاح کننده دسترسی در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-11.png "مشخص کننده دسترسی محافظت شده یا اصلاح کننده دسترسی در سی شارپ")
...
![مشخص‌کننده دسترسی محافظت‌شده یا اصلاح‌کننده دسترسی در سی‌شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-12.png "مشخص‌کننده دسترسی محافظت‌شده یا اصلاح‌کننده دسترسی در سی‌شارپ به همراه مثال")
...
![مشخص‌کننده دسترسی محافظت‌شده یا اصلاح‌کننده دسترسی در سی‌شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-13.png "مشخص‌کننده دسترسی محافظت‌شده یا اصلاح‌کننده دسترسی در سی‌شارپ به همراه مثال")
...
![مشخص کننده دسترسی داخلی محافظت شده یا اصلاح کننده دسترسی در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-14.png "مشخص کننده دسترسی داخلی محافظت شده یا اصلاح کننده دسترسی در سی شارپ")
...
![مشخص کننده دسترسی خصوصی یا اصلاح کننده دسترسی در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-15.png "مشخص کننده دسترسی خصوصی یا اصلاح کننده دسترسی در سی شارپ")
...
![مشخص کننده دسترسی داخلی محافظت شده یا اصلاح کننده دسترسی در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-16.png "مشخص کننده دسترسی داخلی محافظت شده یا اصلاح کننده دسترسی در سی شارپ")
...
![مشخص‌کننده‌های دسترسی در سی‌شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/08/access-specifier-in-c.jpeg "مشخص‌کننده‌های دسترسی در سی‌شارپ به همراه مثال")
...
![مشخص کننده‌های دسترسی با نوع در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/08/access-specifiers-with-type-in-c.jpeg "مشخص کننده‌های دسترسی با نوع در سی شارپ")
...
![مثالی برای درک مشخص‌کننده‌های دسترسی داخلی و عمومی در سی‌شارپ با نوع](https://dotnettutorials.net/wp-content/uploads/2022/08/word-image-29911-19.png "مثالی برای درک مشخص‌کننده‌های دسترسی داخلی و عمومی در سی‌شارپ با نوع")
