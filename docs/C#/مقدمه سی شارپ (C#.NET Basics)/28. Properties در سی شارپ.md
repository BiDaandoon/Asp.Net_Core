...
![مثال برای درک ویژگی‌ها در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2018/08/Example-to-Understand-Properties-in-C.png "مثال برای درک ویژگی‌ها در سی شارپ")
...
![مثالی برای درک ویژگی خواندن و نوشتن در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2018/08/Example-to-understand-the-Read-and-Write-Property-in-C.png "مثالی برای درک ویژگی خواندن و نوشتن در سی شارپ")
...
![مثالی برای درک ویژگی‌های فقط خواندنی و فقط نوشتنی در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2018/08/Example-to-understand-the-Read-Only-and-Write-Only-Properties-in-C.png "مثالی برای درک ویژگی‌های فقط خواندنی و فقط نوشتنی در سی شارپ")
...
![مثالی برای درک ویژگی‌های پیاده‌سازی خودکار در سی‌شارپ](https://dotnettutorials.net/wp-content/uploads/2018/08/Example-to-understand-Auto-Implemented-Properties-in-C.png "مثالی برای درک ویژگی‌های پیاده‌سازی خودکار در سی‌شارپ")
...
![کد IL مربوط به ویژگی‌های پیاده‌سازی خودکار در سی‌شارپ](https://dotnettutorials.net/wp-content/uploads/2018/08/IL-Code-of-Auto-Implemented-Properties-in-C.png "کد IL مربوط به ویژگی‌های پیاده‌سازی خودکار در سی‌شارپ")
...
![چرا در برنامه‌های بلادرنگ سی‌شارپ به ویژگی‌ها (Properties) نیاز داریم؟](https://dotnettutorials.net/wp-content/uploads/2018/08/Why-do-we-need-Properties-in-C-Real-time-Applications.png "چرا در برنامه‌های بلادرنگ سی‌شارپ به ویژگی‌ها (Properties) نیاز داریم؟")
...
![مثال استفاده از متدهای Setter و Getter در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2018/08/Example-using-Setter-and-Getter-Methods-in-C.png "مثال استفاده از متدهای Setter و Getter در سی شارپ")
...
![مثال استفاده از ویژگی‌ها در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2018/08/Example-using-Properties-in-C.png "مثال استفاده از ویژگی‌ها در سی شارپ")