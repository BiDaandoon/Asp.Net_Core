...
![سینتکس دستورات Switch در زبان سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/04/syntax-of-switch-statements-in-c-language.png "سینتکس دستورات Switch در زبان سی شارپ")
...
![دستور سوئیچ تو در تو در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/04/Nested-Switch-Statement-in-C.jpg "دستور سوئیچ تو در تو در سی شارپ")
