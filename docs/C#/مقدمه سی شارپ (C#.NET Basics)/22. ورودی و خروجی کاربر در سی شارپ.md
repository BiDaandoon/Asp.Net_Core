...
![ورودی و خروجی در سی شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-52.png "ورودی و خروجی در سی شارپ به همراه مثال")
...
![مثال‌هایی برای چاپ یک رشته در کنسول در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-53.png "مثال‌هایی برای چاپ یک رشته در کنسول در سی شارپ")
...
![تفاوت بین متد WriteLine() و Write() از کلاس Console در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-54.png "تفاوت بین متد WriteLine() و Write() از کلاس Console در سی شارپ")
...
![مثال چاپ متغیرها و لیترال‌ها با استفاده از متدهای WriteLine() و Write() در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-55.png "مثال چاپ متغیرها و لیترال‌ها با استفاده از متدهای WriteLine() و Write() در سی شارپ")
...
![مثال چاپ رشته الحاق شده با استفاده از عملگر + در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-56.png "مثال چاپ رشته الحاق شده با استفاده از عملگر + در سی شارپ")
...
![خالی](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-57.png)
...
![مثالی برای نشان دادن تفاوت بین متدهای Read() و ReadKey() در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-58.png "مثالی برای نشان دادن تفاوت بین متدهای Read() و ReadKey() در سی شارپ")
...
![مثال خواندن مقادیر عددی از کاربر با استفاده از کلاس Convert در سی شارپ](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-59.png "مثال خواندن مقادیر عددی از کاربر با استفاده از کلاس Convert در سی شارپ")
...
![ورودی و خروجی در سی شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-60.png "ورودی و خروجی در سی شارپ به همراه مثال")
...
![ورودی و خروجی در سی شارپ به همراه مثال](https://dotnettutorials.net/wp-content/uploads/2022/05/word-image-61.png "ورودی و خروجی در سی شارپ به همراه مثال")